      ...
      <div style={{
        ...
        <main>
          ...
          <ul style={{ listStyle: 'none', paddingLeft: 0, fontSize: '1.2rem', lineHeight: '2rem' }}>
            <li><Link href="/submit"><a style={{ color: '#006BA6' }}>📤 Submit Your Story</a></Link></li>
            <li><Link href="/awards"><a style={{ color: '#006BA6' }}>🏆 Awards Panel</a></Link></li>
            <li><Link href="/raffle"><a style={{ color: '#006BA6' }}>🎟️ Raffle Widget</a></Link></li>
            <li><Link href="/careduel"><a style={{ color: '#006BA6' }}>💖 CareDuel Banner</a></Link></li>
          </ul>
        </main>
